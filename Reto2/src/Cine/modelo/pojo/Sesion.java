...
class Sesion {
	...
	public Sesion(int id_sesion, int id_sala, Date fecha_hora_inicio, Date fecha_hora_fin, int precio,
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(fecha_hora_fin, other.fecha_hora_fin)
				...
				&& num_espectadores == other.num_espectadores && precio == other.precio;
	}
